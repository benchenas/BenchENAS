...
class StatusUpdateTool(object):
    ...
    def get_network_params(cls):
        ...
        params['conv_output_channel_prob'] = cls._read_network_parameters_helper('network', 'conv_output_channel_prob',
                                                                                 'float')
        ...
        params['conv_concatenate_to_prob'] = cls._read_network_parameters_helper('network', 'conv_concatenate_to_prob',
                                                                                 'float')
