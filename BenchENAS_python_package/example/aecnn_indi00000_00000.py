...
class EvoCNNModel(nn.Module):
    def __init__(self):
        ...
        self.op0 = DenseNetUnit(k=20, amount=4, in_channel=3, out_channel=83, max_input_channel=64)
        self.op1 = ResNetUnit(amount=7, in_channel=83, out_channel=128)
        self.op4 = ResNetUnit(amount=7, in_channel=128, out_channel=128)
        self.op5 = ResNetUnit(amount=4, in_channel=128, out_channel=128)
